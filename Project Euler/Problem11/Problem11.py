...
def maxAdjacent(grid):
    for row in range(19):
        for column in range(19):
            up(grid,row,column)
            down(grid,row,column)
            left(grid,row,column)
            right(grid,row,column)
            rightDiagonal(grid,row,column)
            leftDiagonal(grid,row,column)
